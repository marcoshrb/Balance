...
public static class Resources
{
    ...
    public static readonly Bitmap SquareEmpty = LoadImage(@"Assets\Shapes\piecesEmpty\Quadrado.png");
    ...
    public static readonly Bitmap PentagonEmpty = LoadImage(@"Assets\Shapes\piecesEmpty\Pentagono.png");
    ...
    public static readonly Bitmap TriangleEmpty = LoadImage(@"Assets\Shapes\piecesEmpty\Triangulo.png");
